...
public class FriendCommand implements CommandExecutor {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
        ...
        if (args.length == 0) {
            player.sendMessage(ChatColor.RED + "Utilisation: /friend <add/remove/accept/deny> <player>");
            return false;
        }
        ...
        player.sendMessage(ChatColor.RED + "Utilisation: /friend <add/remove/accept/deny/list> <player>");
        return false;
    }
}
